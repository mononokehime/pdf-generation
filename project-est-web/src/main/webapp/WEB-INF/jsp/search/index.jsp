	...
	<body class="bodyBackground" onload="hideMenues()">
		...
		<table class="mainTable">
			<tr>
				...
				<form:form commandName="searchParameters" action="${pageContext.servletContext.contextPath}/search/search.do" method="post">
				<input type="hidden" name="workflowStatus" value="received"/>
				<table>
				<tr>
